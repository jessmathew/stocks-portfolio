...
stockNamesWithHighestSharpeRatios <- sharpeRatiosWithStockIndex %>% arrange(desc(SharpeRatio)) %>% slice(1:50)
...
totalReturnForTheForecastingWindow <- colSums(totalReturnsForTheForecastingWindowByDay)
totalReturnForTheForecastingWindow
