...
## Fill in the missing NA values with reasonable estimates.
...
dim(finalTenYearsStockHistoryData)
...
## Detect and replace the outliers and missing values with estimates that are more consistent with the majority of the data

# impute <- mice(dailyLogReturns[,-1], 1, seed = 1)
# imputedStockAssetData <- complete(impute, 1)
# 
# write.csv(imputedStockAssetData,"C:\\Users\\jessm\\OneDrive\\Documents\\Columbia University\\Summer 2019\\GR5261 - Statistical Methods in Finance\\Take Home Project\\AMEX NYSE NASDAQ Stock Histories\\ImputedFullLogStockAssetData.csv", row.names = FALSE)
```
